...
r.post('/start', authRequired, async (req, res) => {
  ...
  try {
    // İlan & satıcı — sadece aktif ilanlar
    ...
    if (uid === l.seller_id) {
      // Satıcı ise konuşacağı kişi alıcı olmalı
    ...
    // Yoksa oluştur (dupe yakalanırsa tekrar select ile döndür)
    try {
